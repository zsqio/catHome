    ...
    <div class="mdl-layout mdl-js-layout">
      ...
      <div class="mdl-layout__drawer">
        ...
        <nav class="mdl-navigation">
          <a href="/#/" @click="hideMenu" class="mdl-navigation__link">Home</a>
          <a href="/#/post" class="mdl-navigation__link">Post a picture</a>
        </nav>
      </div>
...
export default {
  ...
  methods: {
    hideMenu () {
      document.querySelector('.mal-layout__drawer')
